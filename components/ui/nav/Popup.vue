<template>
    <div class="bg-white rounded-t-[10px] absolute -translate-y-full p-[10px] flex flex-col items-center gap-[10px]" role="menu"
        @focusin="$emit('focusin')"
        @focusout="$emit('focusout')"
    >
        <div v-for="(item, idx) in items" :key="item.icon" class="group/popup" role="menuitem" :tabindex="0" :aria-label="item.tooltip"
