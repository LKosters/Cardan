    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-col md:flex-row gap-6">
        ...
        <div class="md:w-2/3 bg-[#fff9e6] p-4 rounded-lg relative">
          <div class="relative">
            <img
              src="/bloemenwinkel/Folder-mockup-free-psd.jpg"
          ...
          <div class="min-w-[220px] flex-shrink-0">
            <div class="bg-white rounded-lg shadow-md overflow-hidden relative">
              ...
              <div class="p-4">
                ...
                <h3 class="text-[#2d5741] font-medium text-sm mb-2">Stekjes</h3>
                <div class="flex justify-between items-center">
          ...
          <div class="min-w-[220px] flex-shrink-0">
            <div class="bg-white rounded-lg shadow-md overflow-hidden relative">
              ...
              <div class="p-4">
                ...
                <h3 class="text-[#2d5741] font-medium text-sm mb-2">Cactus</h3>
                <div class="flex justify-between items-center">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
          <div class="relative">
            ...
            />
            <div
              class="absolute top-4 left-4 bg-[#e4004f] text-white text-xs px-3 py-1 rounded-full"
            >
              Kamerplanten
            </div>
          </div>
          <div class="p-6">
            <h3 class="text-[#2d5741] font-bold text-xl mb-2">
              Fris je kamerplanten op
            </h3>
            <p class="text-gray-600 mb-4">
              Kamerplanten hebben ook in de winter zorg en aandacht nodig. Lees
              hier hoe je jouw groene vrienden fris en gezond houdt tijdens de
              koude maanden.
            </p>
            <div
              class="bg-[#2d5741] text-white px-4 py-2 rounded-full text-sm inline-block"
            >
              Lees meer
            </div>
          </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div class="p-6">
            <h3 class="text-[#2d5741] font-bold text-xl mb-2">
              11 tips voor een bijvriendelijke tuin
            </h3>
            <p class="text-gray-600 mb-4">
              Tuinplanten zijn niet alleen mooi voor het oog, maar ook
              belangrijk voor bijen en andere insecten. Ontdek hoe je jouw tuin
              bijvriendelijk maakt.
            </p>
            <div
              class="bg-[#2d5741] text-white px-4 py-2 rounded-full text-sm inline-block"
            >
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden relative">
              ...
              <div class="p-4">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <span class="text-gray-400 line-through text-sm">699,00</span>
                </div>
              </div>
            </div>
          </div>
