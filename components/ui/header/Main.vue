    ...
    <div class="container mx-auto px-4 py-4 flex items-center justify-between">
      ...
      <div class="flex items-center">
        <NuxtLink to="/" class="flex items-center">
          ...
          >
            ...
            <g class="beeldmerk">
              <circle class="cls-3" cx="10.13" cy="24.75" r="10.13"></circle>
              <circle class="cls-1" cx="26.5" cy="10.19" r="10.13"></circle>
              <path
                class="cls-2"
        ...
        <template v-for="item in navItems" :key="item.label">
          <div v-if="item.children" class="relative group">
            <button class="flex items-center focus:outline-none cursor-pointer">
              <span class="border-transparent border-b hover:border-black">{{
                item.label
              }}</span>
              <svg
                class="ml-1 size-5 group-hover:rotate-180 transition-transform duration-300 group-hover:bg-primary-alt rounded-full p-1"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <div
              class="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-md py-2 z-10 hidden group-hover:block"
            >
              <NuxtLink
                v-for="child in item.children"
                :key="child.to"
                :to="child.to"
                class="block px-4 py-2 hover:bg-primary-alt"
          ...
          <NuxtLink
            v-else
            :to="item.to"
            class="border-transparent border-b hover:border-black"
            >{{ item.label }}</NuxtLink
          >
        </template>
      </nav>
      ...
      <div class="flex items-center">
        <button
          ...
          :class="{ 'font-bold': currentLanguage === 'nl' }"
        >
          NL
        </button>
