<template>
    <div class="coppelmans-homepage">
      ...
      <!-- Hero Section -->
      <section class="py-8 bg-[#fff9e6]">
        <div class="container mx-auto px-4">
          <div class="flex flex-col md:flex-row gap-6">
            <!-- Folder/Brochure -->
            <div class="md:w-2/3 bg-[#fff9e6] p-4 rounded-lg relative">
              <div class="relative">
                <img 
                  src="/" 
                ...
                <div class="absolute bottom-4 right-4 flex flex-col items-end">
                  <h3 class="text-[#e4004f] text-2xl font-medium mb-2">Bekijk de folder</h3>
                  <button class="bg-[#e4004f] text-white rounded-full p-2">
            ...
            <div class="md:w-1/3 flex flex-col gap-4">
              ...
              <div class="bg-[#f0f5f0] rounded-lg overflow-hidden shadow-md flex">
                ...
                <div class="w-1/2 relative">
                  <img 
                    src="/"" 
                    alt="Gazonmax product" 
                    class="w-full h-full object-cover"
                  />
                  <div class="absolute top-4 left-4 bg-[#e4004f] text-white rounded-full p-2 flex flex-col items-center">
      ...
      <section class="py-8">
        <div class="container mx-auto px-4">
          <div class="text-center mb-6">
            <h2 class="text-[#2d5741] text-2xl font-bold">Favoriete categorieën</h2>
          </div>
          
          <div class="relative">
            <!-- Previous Button -->
            <button class="absolute left-0 top-1/2 transform -translate-y-1/2 z-10 bg-white rounded-full p-2 shadow-md">
              <ChevronLeftIcon class="h-6 w-6 text-[#2d5741]" />
            </button>
            ...
            <div class="flex overflow-x-auto gap-4 py-4 px-8">
              ...
              <div class="min-w-[250px] flex-shrink-0">
                <div class="rounded-lg overflow-hidden shadow-md relative">
                  ...
                  />
                  <div class="absolute bottom-0 left-0 right-0 bg-white bg-opacity-90 py-2 px-4 text-center">
            ...
            <!-- Next Button -->
            <button class="absolute right-0 top-1/2 transform -translate-y-1/2 z-10 bg-white rounded-full p-2 shadow-md">
              <ChevronRightIcon class="h-6 w-6 text-[#2d5741]" />
            </button>
          </div>
        </div>
      </section>
      ...
      <section class="py-8">
        <div class="container mx-auto px-4">
          <div class="flex justify-between items-center mb-6">
            ...
            <NuxtLink to="/aanbiedingen" class="text-[#2d5741] text-sm">
            ...
            <div class="flex overflow-x-auto gap-4 py-4 px-8">
              ...
              <div class="min-w-[220px] flex-shrink-0">
                <div class="bg-white rounded-lg shadow-md overflow-hidden relative">
                  ...
                  />
                  <div class="p-4">
                    <p class="text-gray-500 text-xs mb-1">Decoratieve pot van...</p>
                    <h3 class="text-[#2d5741] font-medium text-sm mb-2">Betonnen pot</h3>
              ...
              <div class="min-w-[220px] flex-shrink-0">
                <div class="bg-white rounded-lg shadow-md overflow-hidden relative">
                  ...
                  />
                  <div class="p-4">
                    <p class="text-gray-500 text-xs mb-1">Kunstplant in pot</p>
                    <h3 class="text-[#2d5741] font-medium text-sm mb-2">Kunstboom</h3>
                    <div class="flex justify-between items-center">
              ...
              <div class="min-w-[220px] flex-shrink-0">
                <div class="bg-white rounded-lg shadow-md overflow-hidden relative">
                  ...
                  />
                  <div class="p-4">
                    <p class="text-gray-500 text-xs mb-1">Pot keramiek blauw</p>
                    <h3 class="text-[#2d5741] font-medium text-sm mb-2">Keramische pot</h3>
                    <div class="flex justify-between items-center">
              ...
              <div class="min-w-[220px] flex-shrink-0">
                <div class="bg-white rounded-lg shadow-md overflow-hidden relative">
                  ...
                  />
                  <div class="p-4">
                    <p class="text-gray-500 text-xs mb-1">Bloeiende tuinplant</p>
                    <h3 class="text-[#2d5741] font-medium text-sm mb-2">Viooltjes</h3>
                    <div class="flex justify-between items-center">
                      <span class="text-[#e4004f] font-bold">8,99</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="container mx-auto px-4">
          <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            <div class="flex flex-col items-center">
              <div class="bg-[#f8d7d7] rounded-full p-6 mb-3">
                <FileTextIcon class="h-8 w-8 text-[#2d5741]" />
              </div>
              <h3 class="text-[#2d5741] font-medium uppercase text-sm">Folders</h3>
            </div>
            
            <!-- Link 2 -->
            <div class="flex flex-col items-center">
              <div class="bg-[#e8e1f4] rounded-full p-6 mb-3">
                <GiftIcon class="h-8 w-8 text-[#2d5741]" />
              </div>
              <h3 class="text-[#2d5741] font-medium uppercase text-sm">Cadeaukaart</h3>
            </div>
            
            <!-- Link 3 -->
            <div class="flex flex-col items-center">
              <div class="bg-[#ffeeb3] rounded-full p-6 mb-3">
                <NewspaperIcon class="h-8 w-8 text-[#2d5741]" />
              </div>
            ...
            <!-- Link 4 -->
            <div class="flex flex-col items-center">
              <div class="bg-[#d7f0dd] rounded-full p-6 mb-3">
                <CreditCardIcon class="h-8 w-8 text-[#2d5741]" />
              </div>
            ...
            <div class="flex flex-col items-center">
              <div class="bg-[#d7f0dd] rounded-full p-6 mb-3">
                <StoreIcon class="h-8 w-8 text-[#2d5741]" />
              </div>
              <h3 class="text-[#2d5741] font-medium uppercase text-sm">Winkels</h3>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="py-8">
        <div class="container mx-auto px-4">
          <div class="text-center mb-6">
            <h2 class="text-[#2d5741] text-2xl font-bold">Blogs</h2>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
              <div class="relative">
                ...
                />
                <div class="absolute top-4 left-4 bg-[#e4004f] text-white text-xs px-3 py-1 rounded-full">
                  Kamerplanten
                </div>
              </div>
              <div class="p-6">
                <h3 class="text-[#2d5741] font-bold text-xl mb-2">Fris je kamerplanten op</h3>
                <p class="text-gray-600 mb-4">
                  Kamerplanten hebben ook in de winter zorg en aandacht nodig. Lees hier hoe je jouw groene vrienden fris en gezond houdt tijdens de koude maanden.
                </p>
                <button class="bg-[#2d5741] text-white px-4 py-2 rounded-full text-sm">
                  Lees meer
                </button>
              </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div class="p-6">
                <h3 class="text-[#2d5741] font-bold text-xl mb-2">11 tips voor een bijvriendelijke tuin</h3>
                <p class="text-gray-600 mb-4">
                  Tuinplanten zijn niet alleen mooi voor het oog, maar ook belangrijk voor bijen en andere insecten. Ontdek hoe je jouw tuin bijvriendelijk maakt.
                </p>
                <button class="bg-[#2d5741] text-white px-4 py-2 rounded-full text-sm">
                  Lees meer
                </button>
      ...
      <section class="py-8">
        <div class="container mx-auto px-4">
          <div class="text-center mb-6">
            <h2 class="text-[#2d5741] text-2xl font-bold">Populaire artikelen</h2>
          </div>
            ...
            <div class="flex overflow-x-auto gap-4 py-4 px-8">
              ...
              <div class="min-w-[280px] flex-shrink-0">
                <div class="bg-white rounded-lg shadow-md overflow-hidden relative">
                  ...
                  />
                  <div class="p-4">
                    <p class="text-gray-500 text-xs mb-1">Soho 2-zits loungebank</p>
                    <div class="flex justify-between items-center">
                      <span class="text-[#e4004f] font-bold">1.499,00</span>
                      <span class="text-gray-400 line-through text-sm">1.699,00</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="min-w-[280px] flex-shrink-0">
                <div class="bg-white rounded-lg shadow-md overflow-hidden relative">
                  ...
                  />
                  <div class="p-4">
                    <p class="text-gray-500 text-xs mb-1">Baltimore 5-delig loungebank</p>
                    <div class="flex justify-between items-center">
                      <span class="text-[#e4004f] font-bold">1.199,00</span>
                      <span class="text-gray-400 line-through text-sm">1.399,00</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="min-w-[280px] flex-shrink-0">
                <div class="bg-white rounded-lg shadow-md overflow-hidden relative">
                  ...
                  />
                  <div class="p-4">
                    <p class="text-gray-500 text-xs mb-1">Rio hoek loungebank</p>
                    <div class="flex justify-between items-center">
              ...
              <div class="min-w-[280px] flex-shrink-0">
                <div class="bg-white rounded-lg shadow-md overflow-hidden relative">
                  ...
                  />
                  <div class="p-4">
                    <p class="text-gray-500 text-xs mb-1">Kussen 45 x 45 gekleurd</p>
                    <div class="flex justify-between items-center">
      ...
      <section class="py-8 bg-[#f0f5f0]">
        <div class="container mx-auto px-4">
          <div class="text-center mb-6">
            <h2 class="text-[#2d5741] text-2xl font-bold">Instagram</h2>
            <p class="text-gray-600">Volg ons op Instagram</p>
          </div>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="relative group overflow-hidden rounded-lg">
              ...
              <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-30 transition-opacity duration-300 flex items-center justify-center">
                <InstagramIcon class="h-8 w-8 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </div>
            </div>
      ...
      <section class="py-8">
        <div class="container mx-auto px-4">
          <div class="text-center mb-6">
            <h2 class="text-[#2d5741] text-2xl font-bold">Favoriete merken</h2>
          </div>
          ...
          <div class="relative">
            ...
            <!-- Brands Carousel -->
            <div class="flex overflow-x-auto gap-8 py-4 px-8 items-center">
              <div class="min-w-[150px] flex-shrink-0 flex items-center justify-center">
                <img 
                  src="/" 
                  alt="Brand logo" 
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul class="space-y-2 text-sm">
                <li><NuxtLink to="/vacatures" class="hover:underline">Alle vacatures</NuxtLink></li>
                <li><NuxtLink to="/vacatures/verkoop" class="hover:underline">Verkoop medewerker</NuxtLink></li>
                <li><NuxtLink to="/vacatures/kassa" class="hover:underline">Kassa medewerker</NuxtLink></li>
                <li><NuxtLink to="/vacatures/logistiek" class="hover:underline">Logistiek medewerker</NuxtLink></li>
                <li><NuxtLink to="/vacatures/management" class="hover:underline">Management</NuxtLink></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <h3 class="font-bold text-lg mt-6 mb-4">Blijf op de hoogte van de laatste trends</h3>
