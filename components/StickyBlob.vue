<template>
  <div 
    :class="['fixed w-[22vw] h-[22vw] z-10 pointer-events-none flex justify-center items-center transition-all duration-300', positionClass]"
    @click="handleMisclick"
  >
    <img src="/blob2.png" alt="Icoon blob ontdek jezelf" class="w-full h-full object-contain" />
    <div class="absolute flex flex-col items-center justify-center text-center p-12 mt-6 pointer-events-auto">
